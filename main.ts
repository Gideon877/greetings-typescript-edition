...
var user = <HTMLInputElement>document.getElementById('fname');

var english = <HTMLInputElement>document.getElementById('english');
var setswana = <HTMLInputElement>document.getElementById('setswana');
var zulu = <HTMLInputElement>document.getElementById('zulu');
var nameGreeted = {}
function main() {
